...
def train():
    ...
    total_step = 0
    step = 0
    state = np.array([1 for i in range(10)])
    while True:
        step += 1
        total_step += 1
        ...
        if np.sum(next_state) == 0:
            ...
            c_reward = -0.3*np.sum(next_state)
    ...
    while episode_loop:
        ...
        while step_loop:
            ...
            if step >= max_step:
                ...
                print(
                    "{}episode  reward_avg:{} state_avg:{} loss:{} td_error:{}"
                    .format(num_episode, reward_avg, state_avg,
